...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('Api-Alc:Dashboard')) < Date.now()) {
      localStorage.setItem('Api-Alc:Dashboard', (Date.now()) + (15 * 60 * 1000))
      // eslint-disable-next-line no-alert
      console.log('HTML BY ConfuMods\nCopyright 2021-2022')
  ...
  var $dropdown_legacy_offset_container = $('<div />', { class: 'mb-1' }).append($dropdown_legacy_offset_checkbox).append('<span>Menú desplegable</span>')
  ...
  var $sidebar_mini_container = $('<div />', { class: 'mb-1' }).append($sidebar_mini_checkbox).append('<span>Barra lateral Mini</span>')
  ...
  $container.append('<h6>Opciones de texto</h6>')
