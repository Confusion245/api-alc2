...
function getvisitor(){
    var xhr = new XMLHttpRequest();
    var url = 'https://api.countapi.xyz/hit/api-alc.herokuapp.com/visits';
    xhr.onloadend = function(){
    data = JSON.parse(this.responseText);
...
// User Agent
txt = "";
txt += "<p><b>Version de su Navegador</b>: <br>" + navigator.appVersion + "</p>";
txt += "<p><b>Lenguaje</b>: " + navigator.language + "</p>";
txt += "<p><b>Navegador</b>: " + navigator.appCodeName + "</p>";
txt += "<p><b>Vendedor</b>: " + navigator.vendor + "</p>";
...
txt += "<p><b>Agente de usuario</b>: <br>" + navigator.userAgent + "</p>";
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("IdulAdha").innerHTML = "Feliz Navidad ";
  }
}, 1000);
